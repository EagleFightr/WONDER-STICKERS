/* javascript.js - Wonder Stickers (full version with wa.me fix) */
...
var PRODUCTS = [
  { id: 'p1',  name: 'Happy Diwali Sticker 6*6 cm Pack (10 pcs)', price: 59, img: 'images/p1.png' },
  { id: 'p2',  name: 'subh laabh 15*15 cm (5 pcs)',               price: 45,  img: 'images/p2.png' },
  { id: 'p3',  name: 'happy diwali card 10*8 (5 pcs)',            price: 25, img: 'images/p3.png' },
  { id: 'p4',  name: 'happy diwali card 10*8 (5 pcs)',            price: 25, img: 'images/p4.png' },
  { id: 'p5',  name: 'happy diwali card 10*8 (5 pcs)',            price: 25, img: 'images/p5.png' },
  { id: 'p6',  name: 'subh diwali 6*6 (10 pcs)',                  price: 59,  img: 'images/p6.png' },
  { id: 'p7',  name: 'Happy Diwali Sticker 6*6 cm Pack (10 pcs)', price: 59, img: 'images/p7.png' },
  { id: 'p8',  name: 'happy diwali card 10*8 (5 pcs)',            price: 25,  img: 'images/p8.png' },
  { id: 'p9',  name: 'Happy Diwali Sticker 6*6 cm Pack (10 pcs)', price: 59, img: 'images/p9.png' },
  { id: 'p10', name: 'Hanuman ji Anime style 15*10 cm (1 pcs)',   price: 30, img: 'images/hanuman.png' },
  { id: 'p11', name: 'Karva Chauth Sticker Pack 6*6 cm (4 pcs)',  price: 25,  img: 'images/chara.png' },
  { id: 'p12', name: 'Karva Chauth Sticker Pack 6*6 cm (4 pcs)',  price: 25, img: 'images/charan.png' },
  { id: 'p13', name: "Cuet gannu sticker 15*15 cm (2 pcs)",       price: 90, img: 'images/ctgannu.png' },
  { id: 'p14', name: 'Cuet diya,s sticker pack 6*6 cm (20 pcs)',  price: 99,  img: 'images/deepak2.png' },
  { id: 'p15', name: "Cuet diya,s sticker pack 6*6 cm (20 pcs)",  price: 99,  img: 'images/depak1.png' },
  { id: 'p16', name: "Cuet diya,s sticker pack 6*6 cm (20 pcs)",  price: 99, img: 'images/dpk1.png' },
...
/* ---------- WhatsApp checkout (fixed to wa.me) ---------- */
...
function openWhatsAppCheckout(phone) {
  ...
  // Always use wa.me for all devices (works on mobile app + desktop web)
